...
/*   DesiredCapabilities capabilities = DesiredCapabilities.firefox();
   ...
   public void TestCase35() throws Exception {
 	...
 	//Test Step (1) - A_Link_V__Lending, A
          ...
          Assert.assertTrue(A_Link_V__Lending.isDisplayed(),"Element should exist");          
          assertThat(A_Link_V__Lending.isDisplayed(), is(true));
 	...
 	//Test Step (2) - A_Link_V__Buy a Home, A
          ...
          Assert.assertTrue(A_Link_V__BuyaHome.isDisplayed(),"Element should exist");
 	...
 	//Test Step (3) - INPUT_input_V__text_purchaseAmount, INPUT
          ...
          Assert.assertTrue(NPUT_input_V__text_purchaseAmount.isDisplayed(),"Element should exist");
 	...
 	//Test Step (4) - INPUT_input_V__text_zipCode, INPUT
          ...
          Assert.assertTrue(NPUT_input_V__text_zipCode.isDisplayed(),"Element should exist");
 	...
 	//Test Step (5) - INPUT_input_V__button_ratesGet, INPUT
          ...
          Assert.assertTrue(NPUT_input_V__button_ratesGet.isDisplayed(),"Element should exist");
 	...
 	//Test Step (6) - DIV_Text_V__4.250%, DIV
          ...
          Assert.assertTrue(DV_Text_V__4250.isDisplayed(),"Element should exist");
